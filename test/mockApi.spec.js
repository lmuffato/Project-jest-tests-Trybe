...
describe('verifica o usuário', () => {
  ...
  jest.spyOn(api, 'fetchURL').mockResolvedValue(teste);
  // estou mokando apenas o fetchURL dentro da const api (que é o arquivo mockApi.js) e atribuindo o valor que quero, uso o mockResolvedValue() pois é um fect(promisse), uma função assincrona
