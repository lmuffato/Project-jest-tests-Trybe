...
describe('verifica o usuário', () => {
  // Objeto que retorna dados esperados:
  const userEsperado = {
    gender: 'male',
    name: {
      first: 'Antônio',
  ...
  // mock do "resolve" da fetchURL ():
  api.fetchURL = jest.fn().mockResolvedValue(userEsperado);

  // Teste que capta dados do mock e não da função original:
