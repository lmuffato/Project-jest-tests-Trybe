...
describe('verifica o usuário', () => {
  ...
  jest.spyOn(api, 'fetchURL').mockResolvedValue(data);

  // api.fetchURL = jest.fn().mockResolvedValue(data); outra forma de passar o data
  // requisito feito com auxilio do colega Rafael medeiros
