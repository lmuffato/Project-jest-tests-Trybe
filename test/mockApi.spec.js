...
// referência = Material da trybe tinha uma questão igual, tive de buscar as informações da lista na API  da função
describe('verifica o usuário', () => {
  ...
  api.fetchURL = jest.fn().mockResolvedValue(infoList);
