...
describe('verifica as funções e os mocks', () => {
  ...
  const funcPower = (number, vezesElevado) => number ** vezesElevado;
  ...
  mockFunctions.factorial = jest.fn().mockImplementation(funcFactorial);
  mockFunctions.power = jest.fn().mockImplementation(funcPower);
